...
namespace csExWB
{
    ...
    public class NavigateComplete2EventArgs : System.EventArgs
    {
        ...
        public void SetParameters(object Browser, string Url, bool TopLevel)
        {
            this.browser = Browser;
            this.url = Url;
            istoplevel = TopLevel;
    ...
    public class AuthenticateEventArgs : System.EventArgs
    {
        public AuthenticateEventArgs()
        {
            ...
            this.m_retvalue = 0; //Hresults.S_OK
        }
    ...
    public class ContextMenuEventArgs : System.EventArgs
    {
        ...
        public void SetParameters(WB_CONTEXTMENU_TYPES ContextMenuType, System.Drawing.Point pt, System.Drawing.Point clientpt, object DispCtxMenuObj, IHTMLElement CtxMenuElem)
        {
            this.displaydefault = true;
        ...
        /// <summary>
        /// Display default context menu by MSHTML
        /// Default value true
        /// </summary>
    ...
    public delegate void HTMLMouseEventHandler(object sender, HTMLMouseEventArgs e);
    public class HTMLMouseEventArgs
    {
        //private IntPtr m_hWndWB = IntPtr.Zero;
        ...
        private bool m_Handled = false; //Only applies to LButtonDown + MouseMove events
        private IHTMLElement m_SrcElement = null;

        public HTMLMouseEventArgs(IHTMLElement _SrcElement, int _ClientX, int _ClientY, bool _CtrlKey, bool _ShiftKey, int _OffsetX, int _OffsetY)
        {
            m_SrcElement = _SrcElement;
            m_ClientX = _ClientX;
            m_ClientY = _ClientY;
            m_CtrlKey = _CtrlKey;
            m_ShiftKey = _ShiftKey;
            m_OffsetX = _OffsetX;
            m_OffsetY = _OffsetY;
        }
        ...
        /// <summary>
        /// Active element
        /// This could be an iframe, frame, div, etc.
        /// </summary>
        public IHTMLElement SrcElement
        {
            get { return m_SrcElement; }
        }

        /// <summary>
        /// Only applicable to LButtonDown event
        /// </summary>
        public bool Handled
        {
            get { return m_Handled; }
        ...
        //public bool AltKey
        //{
        //    get { return (WinApis.GetKeyState(0x12) < 0); }
        //}
        ...
        public bool CtrlKey
        {
            ...
            {
                return m_CtrlKey;
                //return (WinApis.GetKeyState(0x11) < 0); 
            }
        }
        ...
        public bool ShiftKey
        {
            ...
            {
                return m_ShiftKey;
                //return (WinApis.GetKeyState(0x10) < 0); 
            }
        }

        public int ClientX
        {
            get { return m_ClientX; }
        }

        public int ClientY
        {
            get { return m_ClientY; }
        }
        ...
        public System.Drawing.Point ClientPoint
        {
            get
            {
                return new System.Drawing.Point(m_ClientX, m_ClientY);
                //tagPOINT pt = new tagPOINT();
                //pt.X = System.Windows.Forms.Cursor.Position.X;
                //pt.Y = System.Windows.Forms.Cursor.Position.Y;
                //WinApis.MapWindowPoints(IntPtr.Zero, m_hWndWB, pt, 1);
                //return new System.Drawing.Point(pt.X, pt.Y);
            }
        }

        public System.Drawing.Point ScreenPoint
        {
    ...
    public delegate void ProcessUrlActionExEventHandler(object sender, ProcessUrlActionExEventArgs e);
    public class ProcessUrlActionExEventArgs : System.ComponentModel.CancelEventArgs
    {
        public bool handled;
        public bool hasContext;
        public string url;
        ...
        public ProcessUrlActionExEventArgs() { }
    ...
    public delegate void TopLevelOnloadEventHandler(object sender, System.ComponentModel.CancelEventArgs e);
    public delegate void TopLevelOnUnloadEventHandler(object sender, System.ComponentModel.CancelEventArgs e);
    public delegate void SecondaryOnloadEventHandler(object sender, SecondaryOnloadEventArgs e);
    public delegate void SecondaryOnUnloadEventHandler(object sender, SecondaryOnloadEventArgs e);

    public class SecondaryOnloadEventArgs : System.ComponentModel.CancelEventArgs
    {
        private SHDocVw.IWebBrowser2 m_pWb;
    ...
    public delegate void FileDownloadExDownloadFileFullyWrittenEventHandler(object sender, FileDownloadExDownloadFileFullyWrittenEventArgs e);
    public class FileDownloadExDownloadFileFullyWrittenEventArgs : System.EventArgs
    {
        public FileDownloadExDownloadFileFullyWrittenEventArgs() { }
        public void SetParameters(int uid, string url, string filename)
        {
            this.m_dlUID = uid;
            this.m_URL = url;
